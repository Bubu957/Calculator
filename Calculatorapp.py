...
openbracket = Button(btns_frame, text = "(", fg = "black", width = 10, height = 3, bd = 0, bg = "#fff", cursor = "hand2", command = lambda: btn_click("(")).grid(row = 0, column = 0, padx = 1, pady = 1)
closebracket = Button(btns_frame, text = ")", fg = "black", width = 10, height = 3, bd = 0, bg = "#fff", cursor = "hand2", command = lambda: btn_click(")")).grid(row = 0, column = 1, padx = 1, pady = 1)
clear = Button(btns_frame, text = "clear", fg = "black", width = 10, height = 3, bd = 0, bg = "#eee", cursor = "hand2", command = lambda: btn_clear()).grid(row = 0, column = 2, padx = 1, pady = 1)
